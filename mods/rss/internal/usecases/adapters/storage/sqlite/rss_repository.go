...
func (r *RssRepository) Feeds() ([]*domain.Feed, error) {
...
func (r *RssRepository) AddFeed(feed *domain.Feed) error {
...
func (r *RssRepository) FeedByName(name string) (*domain.Feed, error) {
	var feed domain.Feed
...
func (r *RssRepository) AddSub(sub *domain.Subscription) error {
...
func (r *RssRepository) UpdateSub(sub *domain.Subscription) error {
...
func (r *RssRepository) RemoveSub(subscription *domain.Subscription) error {
	_, err := r.db.Exec(
...
func (r *RssRepository) Subs(search usecases.SearchParams) ([]*domain.Subscription,
	error) {
...
func (r *RssRepository) scanSub(rows *sql.Rows) (*domain.Subscription, error) {
